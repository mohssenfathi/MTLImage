...
public
class MTLSelectiveHSLFilter1: MTLFilter {
    ...
    override func update() {
        ...
        uniformsBuffer = device.newBuffer(withBytes: &uniforms, length: MemoryLayout<SelectiveHSLUniforms1>.size, options: .cpuCacheModeWriteCombined)
    }
